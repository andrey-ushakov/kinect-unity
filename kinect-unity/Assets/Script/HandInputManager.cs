...
public class HandInputManager : MonoBehaviour
{
    ...
    void Update()
    {
        if (sw.pollSkeleton())
        {
            ...
            Debug.Log("=======");
            */
            if (xHandRelativePos >= rightHandMarginX && yHandRelativePos <= 0.1)
            { // right hand position: down
            ...
            else if (xHandRelativePos >= rightHandMarginX && yHandRelativePos > 0.2 && yHandRelativePos <= 0.4)
            { // right hand position: mid
            ...
            else if (xHandRelativePos >= rightHandMarginX && yHandRelativePos > 0.45)
            { // right hand position: up
